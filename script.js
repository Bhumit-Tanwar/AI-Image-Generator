...
const API_KEY = "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";
...
const updateImageCard = (imgIndex, imgUrl) => {
    ...
    imageCard.innerHTML = ` <img src="${imgUrl}" alt="" class="result-img">
...
const generateImages = async (selectedModel, imageCount, aspectRatio, promptText) => {
    ...
    const imagePromises = Array.from({length: imageCount}, async(_, i) => {
        // send request to the AI api API
        try {
            ...
            imageCard.querySelector(".status-text").textContent = "Generating failed! Check console for more details.";
        }
    })
...
// Switch between light to dark theme
const toggleTheme = () => {
...
// create palaceholder cards with loading spinners
...
// Fill Prompt Input wit random example
